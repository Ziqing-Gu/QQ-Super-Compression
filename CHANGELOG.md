...
- Published the project under the MIT License and added reproducible GitHub Actions builds for Windows VST3, macOS Apple Silicon/Intel VST3 and macOS Universal AU; audio DSP and plug-in state are unchanged.
- Added bilingual installation guides and a Plan D release checklist.
